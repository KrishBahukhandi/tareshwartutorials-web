...
<head>
    ...
    <title>Forgot Password — Tareshwar Tutorials</title>
    <meta name="description" content="Reset your Tareshwar Tutorials account password">
...
<body class="min-h-screen bg-[#f5f7fa] flex">
    ...
    <div class="hidden lg:flex lg:w-5/12 bg-[#031635] flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div class="relative z-10">
            ...
            <h1 class="text-4xl font-extrabold text-white leading-tight mb-5">
                Forgot your<br>
                <span class="text-blue-300">password?<br>No worries.</span>
            </h1>
    ...
    <div class="flex-1 flex items-center justify-center p-6 lg:p-12">
        <div class="w-full max-w-md">
            ...
            <h2 class="text-2xl font-extrabold text-[#031635] mb-1">Reset your password</h2>
            <p class="text-sm text-gray-500 mb-7">Enter the email address associated with your account.</p>
            ...
            <form method="POST" action="{{ route('password.email') }}">
                ...
                <p class="text-center text-sm text-gray-500 mt-5">
                    <a href="{{ route('login') }}" class="text-[#031635] font-semibold hover:underline">← Back to Sign In</a>
                </p>
            </form>
