...
<head>
    ...
    <title>Reset Password — Tareshwar Tutorials</title>
    <meta name="description" content="Set a new password for your Tareshwar Tutorials account">
...
<body class="min-h-screen bg-[#f5f7fa] flex">
    ...
    <div class="hidden lg:flex lg:w-5/12 bg-[#031635] flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div class="relative z-10">
            ...
            <h1 class="text-4xl font-extrabold text-white leading-tight mb-5">
                Almost there.<br>
                <span class="text-blue-300">Set your new<br>password.</span>
            </h1>
    ...
    <div class="flex-1 flex items-center justify-center p-6 lg:p-12">
        <div class="w-full max-w-md">
            ...
            <p class="text-sm text-gray-500 mb-7">Enter your new password below to regain access to your account.</p>
