    ...
    <aside class="w-52 min-w-[208px] bg-white flex flex-col border-r border-gray-200 shadow-sm z-30">
        ...
        <div class="px-3 pb-4">
            <div class="bg-[#1e3a5f] rounded-xl p-3 text-center">
                ...
                <a href="{{ route('support') }}" class="block w-full bg-white text-[#1e3a5f] text-xs font-semibold py-1.5 rounded-lg hover:bg-blue-50 transition-colors">
                    Get Help
                </a>
            </div>
        </div>
