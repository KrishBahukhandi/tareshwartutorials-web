...
<head>
    ...
    <title>@yield('title', 'Tareshwar Tutorials')</title>
    <meta name="description" content="@yield('description', 'Tareshwar Tutorials — Master Your Future with Academic Precision')">
...
<script>
    ...
    <header class="sticky top-0 z-50 bg-white border-b border-gray-200 shadow-sm">
        ...
        <div class="max-w-[1400px] mx-auto px-4 h-[64px] flex items-center justify-between md:justify-start md:gap-3">
            ...
            <form action="{{ route('batches.index') }}" method="GET" class="flex-1 min-w-0 hidden md:block">
                <div class="relative">
                    ...
                    <input type="text" name="search"
                           placeholder="Search for courses or batches..."
    ...
    <div id="mobile-menu-drawer" class="fixed inset-y-0 left-0 w-[280px] bg-white z-[70] transform -translate-x-full transition-transform duration-300 ease-in-out shadow-2xl overflow-y-auto flex flex-col">
        ...
        <div class="p-4 border-b border-gray-100">
            <form action="{{ route('batches.index') }}" method="GET" class="relative">
                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/></svg>
                </div>
                <input type="text" name="search" placeholder="Search..." value="{{ request('search') }}" class="w-full pl-9 pr-4 h-10 border border-gray-300 rounded-lg text-sm bg-gray-50 focus:bg-white focus:ring-2 focus:ring-[#1e3a5f]/20 focus:border-[#1e3a5f]">
            </form>
        </div>
